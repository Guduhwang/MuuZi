<template>
  <el-button v-if="isDev" style="margin-left: 10px" @click="autoCreate">{{ $t('自动添加') }}</el-button>
      ...
      <el-scrollbar class="scrollbar">
        <div v-for="(item, index) in scope.list" :key="index" class="list">
          ...
          <div v-for="(a, ai) in item.api" :key="ai" class="item">
            ...
            <!-- 名称 -->
            <el-input v-model="a.summary" clearable :placeholder="$t('权限名称')" :disabled="!a.checked" />
