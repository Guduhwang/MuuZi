<template>
  <div class="app-topbar">
    ...
    <!-- 路由导航 -->
    <AMenu v-if="app.info.menu.isGroup" />
    <RouteNav v-else />
    ...
    <template v-if="userStore.info">
      <el-dropdown hide-on-click popper-class="app-topbar__user-popper" :popper-options="{}" @command="onCommand">
        <div class="app-topbar__user">
          <el-text class="mr-[10px]">{{ userStore.info.nickName }}</el-text>
          <cl-avatar :size="26" :src="userStore.info.avatar" />
        </div>

        <template #dropdown>
          <div class="userStore">
            <cl-avatar :size="34" :src="userStore.info.avatar" />

            <div class="det">
              <el-text size="small" tag="p">{{ userStore.info.nickName }}</el-text>
              <el-text size="small" type="info">{{ userStore.info.email }}</el-text>
            </div>
          </div>
