...
import ContactForm from '/$/work/index/components/ContactForm.vue';
import FormContentCode from '/$/work/index/components/FormContentCode.vue';
export default {
  components: { FormContentCode, ContactForm },
  setup() {
