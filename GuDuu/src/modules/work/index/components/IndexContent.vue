    ...
    <section class="hero">
      <div class="head">
        ...
        <span class="diple flex">
          >&nbsp;
          <h2 class="line-1 anim-typewriter max-w-fit">Guardian of X2MU</h2>
        </span>
      </div>
      ...
      <div id="info">
        ...
        <span :class="{ hide: isMobile }">
          // You can also download the browser plugin to complete tasks and earn tokens
        </span>
        <span :class="{ hide: !isMobile }">
          // You can also download the browser plugin to complete tasks and earn tokens
        </span>
        <p class="code">
          <span class="identifier"> Download </span>
          <span class="variable-name"> Chrome Extension </span>
          <span class="operator"> = </span>
          <a class="string" :href="'https://chrome.google.com/webstore/detail/x2mu/abcdef1234567890'">
            "https://chrome.google.com/webstore/detail/x2mu/abcdef1234567890"
          </a>
        </p>
      </div>
    </section>
