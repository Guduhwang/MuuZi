...
import type { TChatMemberItem } from '/@/modules/work/types/member.type';
import { inject, nextTick, onMounted, ref, watch } from 'vue';
import { FormInstance, FormItemRule, FormRules } from 'element-plus';
import CodeHighlight from '/@/modules/work/components/code-highlight/CodeHighlight.vue';
import { nodeViewProps, NodeViewWrapper } from '@tiptap/vue-3';
import ChatFlexibleInput from '/@/modules/work/components/chat-editor-2/chat-flexible-input/ChatFlexibleInput.vue';
...
onMounted(() => {
  const params = props.curMentionMember.value.config?.params;
  if (params) {
    nextTick(() => {
